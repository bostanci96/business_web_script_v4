...
$broadCrumb = '<li class="list-inline-item breadcrumb-item"><a href="'.LURL.'"  title="'. $blok["baslik5"].'"> '. $blok["baslik22"].' </a></li><li class="list-inline-item breadcrumb-item"><a href="'.LURL.'urunler/">'.$blok["baslik22"].' </a></li>'.$broadCrumb;
?>
