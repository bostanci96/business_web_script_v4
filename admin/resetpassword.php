...
<head>
    ...
    <meta name="description" content="Administrator | Bostanci96 Yönetim Paneli">
    <meta name="keywords" content="Bostanci96 Yönetim Paneli , Bostanci96 Web Tasarım Yönetim Paneli , Administrator | Bostanci96 Yönetim Paneli, Bostanci96">
    <meta name="author" content="Bostanci96">
    <title>Administrator | Bostanci96 Yönetim Paneli</title>
    <meta property="og:image" content="<?php echo ADMIN_URL;?>app-assets/images/ico/favicon.ico">
    <meta property="og:description" content="Administrator | Bostanci96 Yönetim Paneli">
                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center  js-tilt" data-tilt >
                                    <img src="<?php echo ADMIN_URL;?>app-assets/images/pages/img-02.png" alt="branding logo">
                                </div>
