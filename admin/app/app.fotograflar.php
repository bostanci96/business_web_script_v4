...
if($_GET["p"]=="fotograf_edit"){
	...
	$fotograf_sec 			= p("fotograf_sec");
	$fotograf_src 			= p("fotograf_src");
		$fotograf_sayfa_id 		= p("fotograf_sayfa_id");
	$fotograf_kordi 		= p("fotograf_kordi");
	...
	if(!$fotograf_id || !$fotograf_bolum || !$fotograf_shortDesc){
		...
		$update =$db->query("UPDATE fotograflar SET
			...
			fotograf_sec 		= '$fotograf_sec',
			fotograf_sayfa_id 		= '$fotograf_sayfa_id',
fotograf_kordi 		= '$fotograf_kordi',
