	...
	<div class="content-header row">
		<div class="content-header-left col-md-9 col-12 mb-2">
			<div class="row breadcrumbs-top">
				<div class="col-12">
					<h2 class="content-header-title float-left mb-0">Sabit Alan Düzenle</h2>
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL ;?>">Anasayfa</a>
							</li>

							<li class="breadcrumb-item active"><a href="javascript:void(0);">Sabit Alan Düzenle </a>
							</li>
						</ol>
					</div>
				</div>
				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h4 class="card-title">   <p><b><?php echo $slideRow["fotograf_shortDesc"];?></b> adlı Sabit Alan düzenleniyor.. </p> </h4>
						</div>
									...
									<div class="form-body">
										<div class="row">
												...
												<div class="tab-pane active" id="home-fill" role="tabpanel" aria-labelledby="home-tab-fill">
													...
													<div class="col-12">
														...
														<div class="form-group row">
															...
															<div class="col-md-10">
																<fieldset class="position-relative has-icon-left">
																	<input type="text" id="first-name" class="form-control" name="fotograf_shortDesc2" value="<?php echo $slideRow["fotograf_shortDesc2"];?>" placeholder="">
																	<div class="form-control-position">
																		<i class="feather icon-type"></i>
																	</div>
																</fieldset>
											...
											<div class="col-12">
												<div class="form-group row">
													<div class="col-md-2">
														<span>Sabit Alan Fotoğrafı</span>
													</div>
													<div class="col-md-10">
