            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Sabit Alan Ekle</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?php echo ADMIN_URL ;?>">Anasayfa</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="<?php echo ADMIN_URL ;?>index.php?sayfa=galeri3"> Sabit Alan</a>
                                    </li>
                                    <li class="breadcrumb-item active"><a href="javascript:void(0);"> Sabit Alan Ekle</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                                                    ...
                                                    <div class="col-12">
                                                      ...
                                                      <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-10">
                                                                <fieldset class="position-relative has-icon-left">
                                                                <input type="text" id="first-name" class="form-control" name="fotograf_shortDesc2" placeholder="xxx">
                                                                <div class="form-control-position">
                                                                    <i class="feather icon-type"></i>
                                                                </div>
                                                            </fieldset>
...
$(document).ready(function(event) {
	$('#forms').ajaxForm({
		uploadProgress: function(event, position, total, percentComplete) {
			swal({
				title: "Yükleniyor",
				text : "Sabit Alan Yükleniyor. Lütfen Bekleyiniz",
				type : "info",
		...
		success: function(data) {
			if(data=="bos-deger"){
				...
				sweetAlert({
					title	: "Başarılı",
					text 	: "Sabit Alan Başarılı Bir Şekilde Eklendi",
					type	: "success"
				},
				function(){
