														...
														<fieldset class="form-group">
															<select class="form-control" id="basicSelect" name="menu_type">
																...
																<option value="1"  <?php echo $menuRow["menu_type"]==1 ? 'selected' : null; ?>>Footer(Alt) Menü</option>    
																	<option value="2"  <?php echo $menuRow["menu_type"]==2 ? 'selected' : null; ?>>Taban Menü</option>   
																		<option value="3"  <?php echo $menuRow["menu_type"]==3 ? 'selected' : null; ?>>Slidebar Menü</option>        
															</select>
														</fieldset>
													</div>
												</div>
