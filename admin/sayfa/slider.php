	...
	<div class="content-header row">
		<div class="content-header-left col-md-9 col-12 mb-2">
			<div class="row breadcrumbs-top">
				<div class="col-12">
					<h2 class="content-header-title float-left mb-0">Slider Fotoğrafları</h2>
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL ;?>">Anasayfa</a>
							</li>
							<li class="breadcrumb-item active"><a href="<?php echo ADMIN_URL ;?>index.php?sayfa=slider">Slider Fotoğrafları</a>
							</li>
						</ol>
					</div>
				</div>
...
$detay = $slideRow["fotograf_shortDesc"];
										...
										if($slideRow["fotograf_durum"]==1){ ?>
											...
											<td > <div class="dropdown dropright">
												...
												<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
													...
													<a class="dropdown-item"  onclick="TekSil(<?php echo $slideRow["fotograf_id"];?>);" >Slider'ı Sil</a>
												</div>
											</div>   
