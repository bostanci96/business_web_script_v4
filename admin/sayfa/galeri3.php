	...
	<div class="content-header row">
		<div class="content-header-left col-md-9 col-12 mb-2">
			<div class="row breadcrumbs-top">
				<div class="col-12">
					<h2 class="content-header-title float-left mb-0"> Sabit Alan</h2>
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL ;?>">Anasayfa</a>
							</li>
							<li class="breadcrumb-item active"><a href="<?php echo ADMIN_URL ;?>index.php?sayfa=galeri3"> Sabit Alan</a>
							</li>
						</ol>
					</div>
				</div>
			...
			<div class="table-responsive">
				<div class="actions action-btns"><div class="dt-buttons btn-group">
					...
					<table class="table data-list-view">
						...
						<?php
								$slideQuery = $db->query("SELECT * FROM fotograflar WHERE fotograf_bolum=159753");
									...
									if($slideRow["fotograf_durum"]==1){ ?>
										...
										<td > <div class="dropdown dropright">
											...
											<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
												...
												<a class="dropdown-item"  onclick="TekSil(<?php echo $slideRow["fotograf_id"];?>);" >Sabit Alanı Sil</a>
											</div>
										</div>   
...
function TekSil(slideId){
	$.post('ajax.php?p=tek_foto_sil', {id: slideId}, function (data) {
		if(data=="basarili"){
			sweetAlert({
				title	: "Başarılı",
				text 	: "Sabit Alan başarılı bir şekilde silindi.",
				type	: "success"
			},
			function(){
...
function durumDegis(slideId){
	$.post('ajax.php?p=foto_durum_degis', {id: slideId}, function (data) {
		if(data=="yasaklama-basarili"){
			sweetAlert({
				title	: "Başarılı",
				text 	: "Sabit Alan başarılı bir şekilde yayından kaldırıldı.",
				type	: "success"
			},
			function(){
				window.location.reload(true);
			...
			sweetAlert({
				title	: "Başarılı",
				text 	: "Sabit Alan başarılı bir şekilde yayınlandı.",
				type	: "success"
			},
			function(){
				window.location.reload(true);
