													...
													<div class="col-md-10">
														<fieldset class="form-group">
															<select name="secenekHaber" class="form-control">
																...
																<option value="1">Haberler Alanına Ekle</option>
																	<option value="2">Duyurular Alanına Ekle</option>
																<option value="3"> İhale Alana Ekle</option>

																<option value="4"> Resimsiz Sayfa Ekle</option>
