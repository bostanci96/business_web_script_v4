	...
	<div class="content-header row">
		<div class="content-header-left col-md-9 col-12 mb-2">
			<div class="row breadcrumbs-top">
				<div class="col-12">
					<h2 class="content-header-title float-left mb-0">Müdürlar</h2>
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL ;?>">Anasayfa</a>
							</li>
							<li class="breadcrumb-item active"><a href="<?php echo ADMIN_URL ;?>index.php?sayfa=mudur">Müdürlar</a>
							</li>
						</ol>
					</div>
				</div>
		...
		<section id="data-list-view" class="data-list-view-header">
			...
			<div class="table-responsive">
				<div class="actions action-btns"><div class="dt-buttons btn-group">
					<a href="<?php echo ADMIN_URL?>index.php?sayfa=mudur_ekle" class="btn btn-outline-primary" tabindex="0" aria-controls="DataTables_Table_0"><span><i class="feather icon-plus"></i> Yeni Ekle</span></a> </div></div>
					<table class="table data-list-view">
						...
						<tbody>
							...
							<?php
							$slideQuery = $db->query("SELECT * FROM fotograflar WHERE fotograf_bolum=7896");
							if($slideQuery->rowCount()){
								foreach($slideQuery as $slideRow){
									if(strlen($slideRow["fotograf_shortDesc2"])>1){$slideButton = $slideRow["fotograf_shortDesc2"];}else{$slideButton = "Belirtilmemiş";}
									?>
									<tr>
										<td></td>
										...
										if($slideRow["fotograf_durum"]==1){ ?>
											...
											<td > <div class="dropdown dropright">
												...
												<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
													<a class="dropdown-item" href="index.php?sayfa=mudur_duzenle&id=<?php echo $slideRow["fotograf_id"];?>">Görüntüle / Düzenle</a>
													...
													<a class="dropdown-item"  onclick="TekSil(<?php echo $slideRow["fotograf_id"];?>);" >Müdüryı Sil</a>
												</div>
											</div>   
		...
		function TekSil(slideId){
			$.post('ajax.php?p=tek_foto_sil', {id: slideId}, function (data) {
				if(data=="basarili"){
					sweetAlert({
						title	: "Başarılı",
						text 	: "Müdür başarılı bir şekilde silindi.",
						type	: "success"
					},
					function(){
		...
		function durumDegis(slideId){
			$.post('ajax.php?p=foto_durum_degis', {id: slideId}, function (data) {
				if(data=="yasaklama-basarili"){
					sweetAlert({
						title	: "Başarılı",
						text 	: "Müdür başarılı bir şekilde yayından kaldırıldı.",
						type	: "success"
					},
					function(){
						window.location.reload(true);
					...
					sweetAlert({
						title	: "Başarılı",
						text 	: "Müdür başarılı bir şekilde yayınlandı.",
						type	: "success"
					},
					function(){
						window.location.reload(true);
