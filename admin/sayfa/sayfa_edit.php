							...
							<div class="card-body">
								<form role="form"id="forms" method="POST" action="ajax.php?p=sayfa_edit"  enctype="multipart/form-data">
									...
									<div class="form-body">
																...
																<div class="inner">
																	<div class="img-frame danger">
																		<a class="zooming" href="<?php echo URL;?>images/photos/big/<?php echo $imgRow["fotograf_src"];?>">
																			<div class="img-wrap">
																				<img src="<?php echo URL;?>images/photos/big/<?php echo $imgRow["fotograf_src"];?>" class="col-md-12">
																			</div>
												...
												<div class="col-md-10">
													<fieldset class="form-group">
														<select name="secenekHaber" class="form-control">
															...
															<option value="1" <?php echo $pageRow["secenekHaber"]==1 ? 'selected' : null; ?>>Haberler Alanına Ekle</option>
															<option value="2" <?php echo $pageRow["secenekHaber"]==2 ? 'selected' : null; ?>>Duyurular Alanına Ekle</option>
															<option value="3" <?php echo $pageRow["secenekHaber"]==3 ? 'selected' : null; ?>> İhale Alana Ekle</option>
															<option value="4" <?php echo $pageRow["secenekHaber"]==4 ? 'selected' : null; ?>> Resimsiz Sayfa Ekle</option>
										...
										<div class="col-md-5"><img src="<?php echo URL;?>images/sayfalar/big/<?php echo $pageRow["sayfa_resim"];?>" style="width: 150px;"></div>
										<?php if ($pageRow["secenekHaber"]==1) { ?>
											<!--	<div class="col-12">
													<div class="form-group row">
														<div class="col-md-2">
